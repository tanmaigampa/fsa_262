...
class FinancialDataMapper:
    ...
    def _compute_bs_derived_fields(self, years: List[str]) -> None:
        ...
        for year in years:
            ...
            # Compute total debt - sum all debt components
            ...
            # If total debt not present, compute from components
            if total_debt is None:
                if short_debt is not None and long_debt is not None:
                    ...
                    self.canonical_model.set_value('total_debt', year, short_debt)
                elif long_debt is not None:
                    self.canonical_model.set_value('total_debt', year, long_debt)
